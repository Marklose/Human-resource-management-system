<template>
  <div id="myPrint" class="dashboard-container">
    <div class="app-container">
      <el-card>
        <el-breadcrumb class="titInfo" separator="/">
        ...
        <div v-if="type === 'personal'" id="printObj">
          ...
          <table cellspacing="0" class="tableList" width="100%">
            <tr class="title">
              <td class="centInfo" colspan="8">基本信息</td>
            </tr>
            <tr>
            ...
            <tr class="title">
              <td class="centInfo" colspan="8">通讯信息</td>
            </tr>
            <tr>
              <th>QQ</th>
              <td>{{ formData.qQ }}</td>
            ...
            <tr class="title">
              <td class="centInfo" colspan="8">账号信息</td>
            </tr>
            <tr>
              <th>社保电脑号</th>
            ...
            <tr class="title">
              <td class="centInfo" colspan="8">教育信息</td>
            </tr>
            <tr>
              <th>学历类型</th>
            ...
            <tr class="title">
              <td class="centInfo" colspan="8">从业信息</td>
            </tr>
            <tr>
              <th>上家公司</th>
        ...
        <div v-else id="printObj">
          ...
          <table cellspacing="0" class="tableList" width="100%">
            <tr class="title">
              <td class="centInfo" colspan="4">基本信息</td>
            </tr>
            <tr>
              <th style="width: 10%">姓名</th>
            ...
            <tr class="title">
              <td class="centInfo" colspan="4">合同信息</td>
            </tr>
            <tr>
              <th>首次合同开始时间</th>
            ...
            <tr class="title">
              <td class="centInfo" colspan="4">招聘信息</td>
            </tr>
            <tr>
              <th>其他招聘渠道</th>
